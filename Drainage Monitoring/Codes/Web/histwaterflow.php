...
<body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
                ...
                <div class="animated fadeIn">
                    <div class="card">
                        <div class="card-header">
                            <i class="nav-icon fa fa-fire"></i> Real Time Water Flow Graph
                            <span class="fa-pull-right">Graph Type:  
                              <select id="wflowGraphType" onChange="changeGraph()">
                        ...
                        <div class="card-body" style="padding:10px; margin:0;">
                            <div id="wflow_chart_div">
                                <canvas id="wflow_chart_canvas" width="100%" height="40vh"></canvas>
                            </div>
                        </div>
    ...
    <script src="js/histwflow.js"></script>
</body>
