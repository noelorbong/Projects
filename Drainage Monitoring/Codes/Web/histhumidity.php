...
<body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
                ...
                <div class="animated fadeIn">
                    <div class="card">
                        <div class="card-header">
                            <i class="nav-icon fa fa fa-tint"></i>  Obstruction Level History Graph
                            <span class="fa-pull-right">Graph Type:  
                              <select id="humiGraphType" onChange="changeGraph()">
    ...
    <script src="js/histhumidity.js"></script>
</body>
