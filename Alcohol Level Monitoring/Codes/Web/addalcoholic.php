    ...
    <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
                    ...
                    <div class="animated fadeIn">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <i class="nav-icon fas fa-plus"></i> Add Alcoholic Driver
                            </div>
                            <div class="card-body">
                                <div>
                                    <div class="form-row">
                                        <div class="form-group col-md-6" style="margin-bottom:0">
                                            ...
                                            <input type="text" class="form-control" id="inputLisence" placeholder="E.g. DO1-12-123456" required>
                                        ...
                                        <div class="form-group col-md-6" style="margin-bottom:0">
                                            <label for="inputAlcoholLevel">Alcohol Level</label>
                                            <input type="number" class="form-control" id="inputAlcoholLevel" placeholder="e.g 70 (Value in percent)" required>
                                            <label class="pull-right" style="margin-bottom:0; color:#ff0000; visibility:hidden;" id="inputAlcoholLevelValidator">Alcohol Level Required..</label>
                                        </div>
                                    </div>
        ...
        <script>
            ...
            function getParameters() {
                ...
                if (urlParams.has('alcohol_level')) {
                    document.getElementById('inputAlcoholLevel').value = urlParams.get('alcohol_level');
                    document.getElementById("inputAlcoholLevel").readOnly = true;
                }
            ...
            function saveData() {
                ...
                license_number=" + inputLisence.value + "&name=" + inputName.value + "&address=" + inputAddress.value + "&alcohol_level=" + inputAlcoholLevel.value;

                var d_url = "https://driveralcoholmonitoring.000webhostapp.com/api/driver/create.php? \
                license_number=" + inputLisence.value + "&name=" + inputName.value + "&address=" + inputAddress.value;


                licenseExist(a_url, d_url);
            }
            ...
            function validator(inputLisence, inputAlcoholLevel, inputName, inputAddress) {
                ...
                if (!inputLisence.value) {
                    inputAlcoholLevelValidator.innerHTML = "Driver's Lisence Required.."
                ...
                if (!inputAlcoholLevel.value) {

                    inputLisenceValidator.style.visibility = "hidden";
                    inputAlcoholLevelValidator.style.visibility = "visible";
                    inputNameValidator.style.visibility = "hidden";
                    inputAddressValidator.style.visibility = "hidden";
                    return false;
                } else {
            ...
            function licenseExist(a_url, d_url) {
                var inputLisence = document.getElementById("inputLisence");
                var inputLisenceValidator = document.getElementById("inputLisenceValidator");
                $.ajax({
                    url: "https://driveralcoholmonitoring.000webhostapp.com/api/driver/check.php?lisence_num=" + inputLisence.value,
                    success: function(responseData) {
                        console.log(responseData);

                        if (responseData.count != 0) {
                            inputLisenceValidator.innerHTML = "License Number Exist.."
                            inputLisenceValidator.style.visibility = "visible";
                            inputAlcoholLevelValidator.style.visibility = "hidden";
                            inputNameValidator.style.visibility = "hidden";
                            inputAddressValidator.style.visibility = "hidden";
                            ...
                            console.log("Saving..");
                            sendRequest(a_url, d_url);
                        }
                    }
                });
            }

            function sendRequest(a_url, d_url) {
                $.ajax({
                    url: a_url,
                    success: function(responseData) {
                        saveDriver(d_url);
