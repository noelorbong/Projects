...
-->
    ...
    <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
                    ...
                    <div class="animated fadeIn">
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer text-muted">
                                ...
                                <button onclick="printData()" class="btn btn-primary" style="float:right"><i class="nav-icon fas fa-clipboard-list"> </i> Print</button>
                            </div>
                        </div>
        ...
        <script>
            ...
            function printData() {
                window.location.href = "print.php?current_date=" + currentDate;
            }
