...
def loadKNNDataAndTrainKNN():
    ...
    try:
        npaClassifications = np.loadtxt("classifications2.txt", np.float32)                  # read in training classifications
    ...
    try:
        npaFlattenedImages = np.loadtxt("flattened_images2.txt", np.float32)                 # read in training images
    except:                                                                                 # if file could not be opened
