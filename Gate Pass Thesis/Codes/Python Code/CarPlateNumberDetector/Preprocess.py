...
def preprocess(imgOriginal):
    ...
    imgMaxContrastGrayscale = maximizeContrast2(imgGrayscale)
...
###################################################################################################
def maximizeContrast2(imgGrayscale):
    ...
    imgTopHat = cv2.morphologyEx(imgGrayscale, cv2.MORPH_CLOSE, structuringElement)
    #imgBlackHat = cv2.morphologyEx(imgGrayscale, cv2.MORPH_CLOSE, structuringElement)
