...
public class FragmentMapHistory extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view =  inflater.inflate(R.layout.frame_map_history,
                container, false);
...
//        final Activity activity = this.mainActivity;
        ...
        myWebView.setWebViewClient(new WebViewClient() {
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                ...
                myWebView.loadUrl("file:///android_asset/errorhist.html");
            }
        });

        myWebView.loadUrl("http://wallettracker.1apps.com/history.html");
