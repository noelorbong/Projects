  ...
  <div class="card-body" style="padding:30px; margin:0;">
    <form action="/studentupdate" method="POST">
        ...
        <div class="form-row">
            ...
            <input type="text" value="{{ $student->gender === 1 ? 'Male' :'Female' }}"  class="form-control" readonly>
        ...
        <div class="form-row">
            ...
            <input type="text" value="{{ $student->grade_level }}" class="form-control" name="grade_level" id="grade_level" placeholder="Eg. Grade 7" readonly>
            </div>
            <div class="form-group col-md-6">
            <label for="section">Section</label>
            <input type="text" value="{{ $student->section }}" class="form-control" name="section" id="section" placeholder="e.g. Section 1" readonly>
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-6">
