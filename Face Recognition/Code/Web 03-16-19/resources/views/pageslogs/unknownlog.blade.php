...
<div class="card">
  <div class="card-header">
    <i class="nav-icon fa fa-list-alt"></i>Unknown Logs 
  </div>
...
<script>
  ...
  function printData() {
    ...
    window.open(
      '/printsection/unknown/unknown/' +startDate + '/' + endDate,
  ...
  function sendRequest(startdate,enddate) {
    ...
    var api_url = "/selectsectionlogs/unknown/unknown/"+startdate+"/"+enddate;
