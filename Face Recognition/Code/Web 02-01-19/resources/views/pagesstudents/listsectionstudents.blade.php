...
@section('bodyTitle')
{{$grade_level}}, {{$section}} Students List
@endsection
...
<div class="card">
  <div class="card-header">
    <i class="nav-icon fa fa-list-alt"></i>{{$grade_level}}, {{ $section }} Students List 
...
<script>
  ...
  function sortData(isSearch){
    var rows ="";
    var main_url = ''
    var search = document.getElementById("search").value.trim();
    if(isSearch){
      main_url = '/searchlistsectionstudents/{{$grade_level}}/{{$section}}/'+search
    }else{
      main_url = '/listsectionstudents/{{$grade_level}}/{{$section}}';
    }
