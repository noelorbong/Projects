            ...
            $.each(responseData.co2, function(i, item) {
                ...
                if (getFirstDataTime) {
                    ...
                    if (document.getElementById('senCurrentDate')) {
                        document.getElementById('co2Value').innerHTML = item.value + " ppm";
...
function co2RequestDataUpdate() {
    ...
    $.ajax({
        ...
        success: function(responseData) {
            ...
            if (co2LatestId < id) {
                if (document.getElementById('senCurrentDate')) {
                    document.getElementById('co2Value').innerHTML = value + " ppm";
...
function co2DisplayChart(value, time) {
    ...
    $('#co2chartContent').append('<canvas id="co2Chart"  width="100%" height="40vh" ><canvas>');
