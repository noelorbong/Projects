          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/dashboard2">
                <i class="nav-icon fa fa-dashboard"></i> Dashboard Full View
              </a>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link" style="cursor:pointer" onclick="openSetting()">
                <i class="nav-icon fa fa-cog"></i> Devices Setting
              </a>
            </li>
          </ul>
        </nav>
