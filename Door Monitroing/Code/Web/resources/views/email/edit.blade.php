...
@section('title')
Edit Email Subscriber
@endsection

@section('bodyTitle')
Email Subscriber|Edit
@endsection
...
<div class="card">
  <div class="card-header">
    <i class="nav-icon fa fa-pencil"></i>Edit Email Subscriber
  </div>
  <div class="card-body" style="padding:30px; margin:0;">
    <form action="/emailupdate" method="POST">
        ...
        <div class="form-row">
            ...
            <input type="email" class="form-control" name="email" id="email"  value="{{ $subscriber->email }}"  placeholder="e.g example@gmail.com" required>
            </div>
        </div>
