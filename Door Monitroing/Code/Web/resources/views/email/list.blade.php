...
@section('title')
List Email Subcriber
@endsection

@section('bodyTitle')
Email Subcriber |List
@endsection
...
<div class="card">
  <div class="card-header">
    <i class="nav-icon fa fa-list-alt"></i> Email Subcribers List 
...
<script>
  ...
  function sortData(sortcolum,sort, isSearch){
    ...
    if(isSearch){
      main_url = 'emailsearch/'+search
    }else{
      main_url = 'emailget/'+sortcolum+'/'+sort
    }
          ...
          $.each(responseData.records, function(i, item) {
            ...
            rows += "<td>\
                      <div class=\"text-center\" style=\"background-color: white\">\
                        <a class=\"btn btn-primary btn-sm\" href=\"/emailedit/"+item.id+"\"> Edit</a>"
  ...
  function changeStatus(context, sub_id){
    ...
    console.log(sub_id);
    $.ajax({
        url: "/updateemailstatus/"+sub_id+"/"+checkStatus,
