...
<div class="card">
  <div class="card-header">
    <i class="nav-icon fa fa-plus"></i>Add SMS Subscriber
  </div>
  <div class="card-body" style="padding:30px; margin:0;">
    <form action="/smsstore" method="POST">
        {{ csrf_field() }}
        ...
        <div class="form-row">
            ...
            <input type="number" class="form-control" name="number" id="number" placeholder="e.g 09272327745" required>
            </div>
        </div>
